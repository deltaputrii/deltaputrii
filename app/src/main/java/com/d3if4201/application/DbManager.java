...
public class DbManager extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String qry = "create table tbl_maps(id integer primary key autoincrement,location text)";
        db.execSQL(qry);
    }
    ...
    public String addRecordMaps(String location, String longtitude, String latitude) {
